/* Wayfarer Tooltip
 * Version 1.0.9 + Small Modification by Daniel Durante
 * Author Abel Mohler
 * URI: http://www.wayfarerweb.com/wtooltip.php
 * Released with the MIT License: http://www.wayfarerweb.com/mit.php
 */
(function($){$.fn.wTooltip=function(o,callback){o=$.extend({content:null,ajax:null,follow:true,auto:true,fadeIn:0,fadeOut:0,appendTip:document.body,degrade:false,offsetY:10,offsetX:1,style:{},className:null,id:null,callBefore:function(tooltip,node,settings){},callAfter:function(tooltip,node,settings){},clickAction:function(tooltip,node){$(tooltip).hide();},delay:0,timeout:0},o||{});if(!o.style&&typeof o.style!="object"){o.style={};o.style.zIndex="1000";}
...
top=scrollY;else
if(top>maxTop){top=e.clientY-$(tooltip).height();}
tooltip.style.top=top+"px";tooltip.style.left=left+"px";firstMove=false;}});if(typeof o.clickAction=="function"){$(this).click(function(){o.clickAction(tooltip,this);});}});}})(jQuery);
